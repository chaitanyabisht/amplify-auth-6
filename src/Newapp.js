...
const initialFormState = {
    username:'', password:'',email:'',name:'',phone_number:'',address:'',farm_type:'',authCode:'',formType:'signUp'
}
...
function App() {
    ...
    async function signUp(){
        const {username, email, password, phone_number, address, farm_type} = formState
